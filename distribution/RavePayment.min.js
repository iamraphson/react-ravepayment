...
var RavePayment = function (_Component) {
  ...
  _createClass(RavePayment, [{
    ...
    value: function loadScript(callback) {
      ...
      script.src = !this.props.isProduction ? "https://ravesandboxapi.flutterwave.com/flwv3-pug/getpaidx/api/flwpbf-inline.js" : "https://api.ravepay.co/flwv3-pug/getpaidx/api/flwpbf-inline-deprecated.js";
    ...
    value: function payWithRave() {
      ...
      this.state.scriptLoaded && this.state.scriptLoaded.then(function () {
        window.getpaidSetup({
          ...
          custom_logo: _this3.props.custom_logo || "",
...
RavePayment.propTypes = {
  ...
  campaign_id: _propTypes2.default.string,
