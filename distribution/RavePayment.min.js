...
var RavePayment = function (_Component) {
  ...
  function RavePayment(props) {
    ...
    _this.state = {
      ...
      customer_phone: _this.props.customer_phone || "",
      ...
      subaccounts: _this.props.subaccounts || [{}], //splits payments into subaccounts provided
      payment_method: _this.props.payment_method || "both", //falls back to card and account if none is specified
      payment_plan: _this.props.payment_plan || "", //the id of your payment plan
      redirect_url: _this.props.redirect_url || "", //calls this url after successful payment
      hosted_payment: _this.props.hosted_payment //opens the modal in a new page
    };
    return _this;
  }
    ...
    value: function payWithRave() {
      ...
      this.state.scriptLoaded && this.state.scriptLoaded.then(function () {
        window.getpaidSetup({
          ...
          meta: _this3.state.metadata,
          currency: _this3.state.currency,
          country: _this3.state.country,
          customer_firstname: _this3.state.customer_firstname,
          customer_phone: _this3.state.customer_phone,
          customer_lastname: _this3.state.customer_lastname,
          custom_title: _this3.state.custom_title,
          custom_description: _this3.state.custom_description,
          custom_logo: _this3.state.custom_logo,
          subaccounts: _this3.state.subaccounts,
          payment_method: _this3.state.payment_method,
          payment_plan: _this3.state.payment_plan,
          redirect_url: _this3.state.redirect_url,
          hosted_payment: _this3.state.hosted_payment
        });
      });
    }
  }, {
