...
| payment_method     |  This allows you select the payment option you want for your users, see Choose Payment Methods for more info.[Live](Link:https://developer.flutterwave.com/docs/splitting-payment-methods)| `String` | Not Required
